...
from athena import BaseSolver, DecoderSolver, CTCDecoderSolver, SynthesisSolver, HorovodSolver, ConvertSolver
...
def inference(jsonfile, config, rank_size=1, rank=0):
    ...
    print('config.solver_type {}'.format(config.solver_type))

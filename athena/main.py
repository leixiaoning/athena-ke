...
SUPPORTED_MODEL = {
    ...
    "deep_speech_ce_pb": DeepSpeechModelCE4PB,
    "deep_speech_conv4": DeepSpeechModelConv4,
...
def train(jsonfile, Solver, rank_size=1, rank=0):
    ...
    while epoch < p.num_epochs:
        ...
        solver.train(trainset_builder.as_dataset(p.batch_size, p.num_data_threads), checkpointer)

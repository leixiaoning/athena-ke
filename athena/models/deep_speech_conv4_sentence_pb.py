...
class DeepSpeechModelConv4SentencePB(BaseModel):
    ...
    def __init__(self, data_descriptions, config=None):
        ...
        self.logits = tf.identity(inner, name="logits")
        self.net = tf.keras.Model(inputs=input_feature, outputs=self.logits)

...
def freeze_session(session,keep_var_names=None,output_names=None,clear_devices=True):
    ...
    with graph.as_default():
        ...
        return frozen_graph
        #return remove_training_nodes(frozen_graph)
    #return None
if __name__ == "__main__":
    ...
    #model.load_weights('./deploy/xingcheng/h5/model_xc_0728.h5')
    model.load_weights('./deploy/rengongkefu/h5/model_rengongkefu_2conv64_4_5gru_197.h5')
    ...
    with tf.compat.v1.gfile.GFile("./deploy/rengongkefu/pb/model_rengongkefu_2conv64_4_5gru_197.pb", "wb") as in_f:
